 ...
 *
 * Подпись берётся из атрибута data-cursor на элементе под курсором. Её ставят
 * там, где клик неочевиден (кадр, открывающий полноэкранный просмотр); над
 * обычными ссылками, кнопками и карточками кольцо просто увеличивается.
 */
